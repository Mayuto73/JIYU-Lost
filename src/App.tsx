...
import { Camera, LogOut, Plus, Search, CheckCircle2, Trash2, School, Image as ImageIcon, UserCircle } from 'lucide-react';
...
export default function App() {
  ...
  const handleMarkAsReceived = async (item: LostItem) => {
    ...
    if (!window.confirm("本当に持ち主に渡しましたか？\nこの操作は取り消せません。")) return;
    try {
            ...
            <>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 flex flex-col gap-3">
                  {user && (user.uid === selectedItem.authorUid || isAdmin) && selectedItem.status === '未受取' && (
                    <Button 
                      className="w-full" 
                      size="lg"
