  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        <div className="mb-6 space-y-4">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <Button variant="ghost" className="text-primary whitespace-nowrap ml-2 rounded-full font-medium" onClick={() => setIsLookingForBoardOpen(true)}>
      ...
      <Dialog open={isLookingForBoardOpen} onOpenChange={setIsLookingForBoardOpen}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto rounded-3xl border-0 shadow-xl bg-slate-50">
      ...
      <Dialog open={isPostingLookingFor} onOpenChange={setIsPostingLookingFor}>
        <DialogContent className="sm:max-w-[500px] rounded-3xl border-0 shadow-xl">
          <DialogHeader>
